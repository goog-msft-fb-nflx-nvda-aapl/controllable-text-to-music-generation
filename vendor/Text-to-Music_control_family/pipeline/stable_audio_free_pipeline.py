...
class StableAudioPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        print(audio_start_in_s, audio_end_in_s)
        ...
        prompt_embeds_1 = self.encode_prompt(
            prompt_1,
            device,
            do_classifier_free_guidance,
            negative_prompt,
        ...
        prompt_embeds_2 = self.encode_prompt(
            prompt_2,
            device,
            do_classifier_free_guidance,
            negative_prompt,
        ...
        bs_embed, seq_len, hidden_size = text_audio_duration_embeds_1.shape
        # duplicate audio_duration_embeds and text_audio_duration_embeds for each generation per prompt, using mps friendly method
        text_audio_duration_embeds_1 = text_audio_duration_embeds_1.repeat(1, num_waveforms_per_prompt, 1)
        text_audio_duration_embeds_1 = text_audio_duration_embeds_1.view(
            bs_embed * num_waveforms_per_prompt, seq_len, hidden_size
        )
        text_audio_duration_embeds_2 = text_audio_duration_embeds_2.repeat(1, num_waveforms_per_prompt, 1)
        text_audio_duration_embeds_2 = text_audio_duration_embeds_2.view(
            bs_embed * num_waveforms_per_prompt, seq_len, hidden_size
        )
        ...
        latents = self.prepare_latents(
            ...
            num_channels_vae,
            waveform_length,
            text_audio_duration_embeds_1.dtype,
            device,
            generator,
            latents,
            initial_audio_waveforms,
